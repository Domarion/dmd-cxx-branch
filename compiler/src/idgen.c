...
Msgtable msgtable[] =
{
    ...
    // TODO: backport _d_*
    { "_d_arrayctor", NULL },
    { "_d_arraysetctor", NULL },
    { "_d_arraysetassign", NULL },
    { "_d_arrayassign_l", NULL },
    { "_d_arrayassign_r", NULL },
