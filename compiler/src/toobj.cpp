...
void genModuleInfo(Module *m)
{
    ...
    const unsigned MIstandalone      = 0x4;
    const unsigned MItlsctor         = 0x8;
    const unsigned MItlsdtor         = 0x10;
    const unsigned MIctor            = 0x20;
    const unsigned MIdtor            = 0x40;
    const unsigned MIxgetMembers     = 0x80;
    const unsigned MIictor           = 0x100;
    const unsigned MIunitTest        = 0x200;
    const unsigned MIimportedModules = 0x400;
    const unsigned MIlocalClasses    = 0x800;
    const unsigned MIname            = 0x1000;
