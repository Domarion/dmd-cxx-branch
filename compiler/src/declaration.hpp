...
const uinteger_t STCundefined           = 0LL;
const uinteger_t STCstatic              = 1LL;
const uinteger_t STCextern              = 2LL;
const uinteger_t STCconst               = 4LL;
const uinteger_t STCfinal               = 8LL;
const uinteger_t STCabstract            = 0x10LL;
const uinteger_t STCparameter           = 0x20LL;
const uinteger_t STCfield               = 0x40LL;
const uinteger_t STCoverride            = 0x80LL;
const uinteger_t STCauto                = 0x100LL;
const uinteger_t STCdeprecated          = 0x400LL;
const uinteger_t STCin                  = 0x800LL;        // in parameter
const uinteger_t STCout                 = 0x1000LL;        // out parameter
const uinteger_t STClazy                = 0x2000LL;        // lazy parameter
const uinteger_t STCforeach             = 0x4000LL;        // variable for foreach loop
const uinteger_t STCvariadic            = 0x10000LL;       // the 'variadic' parameter in: T foo(T a, U b, V variadic...)
const uinteger_t STCctorinit            = 0x20000LL;       // can only be set inside constructor
const uinteger_t STCtemplateparameter   = 0x40000LL; // template parameter
const uinteger_t STCscope               = 0x80000LL;
const uinteger_t STCimmutable           = 0x100000LL;
const uinteger_t STCref                 = 0x200000LL;
const uinteger_t STCinit                = 0x400000LL;      // has explicit initializer
const uinteger_t STCmanifest            = 0x800000LL;      // manifest constant
const uinteger_t STCnodtor              = 0x1000000LL;     // don't run destructor
const uinteger_t STCnothrow             = 0x2000000LL;     // never throws exceptions
const uinteger_t STCpure                = 0x4000000LL;     // pure function
const uinteger_t STCtls                 = 0x8000000LL;     // thread local
const uinteger_t STCalias               = 0x10000000LL;    // alias parameter
const uinteger_t STCshared              = 0x20000000LL;    // accessible from multiple threads
// accessible from multiple threads
// but not typed as "shared"
const uinteger_t STCgshared      = 0x40000000LL;
const uinteger_t STCwild         = 0x80000000LL;   // for "wild" type constructor

const uinteger_t STCproperty      = 0x100000000LL;
const uinteger_t STCsafe          = 0x200000000LL;
const uinteger_t STCtrusted       = 0x400000000LL;
const uinteger_t STCsystem        = 0x800000000LL;
const uinteger_t STCctfe          = 0x1000000000LL;  // can be used in CTFE, even if it is static
const uinteger_t STCdisable       = 0x2000000000LL; // for functions that are not callable
const uinteger_t STCresult        = 0x4000000000LL;  // for result variables passed to out contracts
...
const uinteger_t STCinference     = 0x400000000000LL; // do attribute inference
const uinteger_t STCexptemp       = 0x800000000000LL; // temporary variable that has lifetime restricted to an expression
const uinteger_t STCmaybescope    = 0x1000000000000LL; // parameter might be 'scope'
const uinteger_t STCscopeinferred = 0x2000000000000LL; // 'scope' has been inferred and should not be part of mangling
const uinteger_t STCfuture        = 0x4000000000000LL; // introducing new base class function
...
const unsigned FUNCFLAGprintf             = 0x200;   // is a printf-like function
const unsigned FUNCFLAGscanf              = 0x400;   // is a scanf-like function
